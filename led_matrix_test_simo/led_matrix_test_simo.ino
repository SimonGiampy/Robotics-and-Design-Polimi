...
#define MAX_DEVICES 2 // 2 blocks
#define CLK_PIN   18  // or SCK (CLK)
#define DATA_PIN  23  // or MOSI (DIN)
#define CS_PIN    5  // or SS (CS)
...
void loop() {
	ledMatrix.print("69"); // display text
	delay(2000);

	ledMatrix.print("AZ"); // display text
	delay(2000);
}
*/